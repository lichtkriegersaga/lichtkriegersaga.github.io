...
(function () {
  ...
  function injectStyle() {
    ...
    var css = [
      ".sterne-block{box-sizing:border-box;width:min(560px,92vw);margin:1.2rem auto .4rem;padding:.95rem 1.2rem 1.05rem;text-align:center;",
      ...
      ".sterne-orn{display:flex;align-items:center;justify-content:center;gap:.6rem;color:var(--brass,#8a6a3a);font-size:.75rem;margin-bottom:.35rem}",
      ".sterne-orn::before,.sterne-orn::after{content:'';flex:0 1 5.5rem;height:1px;background:linear-gradient(90deg,transparent,#c9a22799,transparent)}",
      ".sterne-q{margin:0 0 .5rem;font-size:1.02rem;font-weight:600;color:#5a3a18;letter-spacing:.01em}",
      ".sterne-stars{display:inline-flex;gap:.3rem;align-items:center;justify-content:center}",
      ".sterne-block .sterne-star{all:unset;display:inline-block;box-sizing:border-box;width:2.5rem;height:2.5rem;padding:.2rem;cursor:pointer;border-radius:5px;line-height:0;",
      ...
      ".sterne-thanks{margin:.5rem 0 0;font-size:.9rem;font-style:italic;color:#5a3a18}",
      ".sterne-avg{margin:.45rem 0 0;font-size:.88rem;color:#5a3a18}",
      ".sterne-avg:empty{display:none}",
      ".sterne-demo{margin:.4rem 0 0;font-size:.66rem;letter-spacing:.12em;text-transform:uppercase;color:#8a3a18;opacity:.85}",
      "@media (max-width:720px){.sterne-block{margin-top:.9rem;padding:.8rem .8rem .9rem}.sterne-block .sterne-star{width:2.35rem;height:2.35rem}.sterne-q{font-size:.95rem}}",
      /* bookshelf badges */
